...
AddAction(0, af_none, "Set enabled", "Settings", "Set {my} {0}", "Enable or disable the behavior.", "SetEnabled");

AddNumberParam("Rate of spawn", "The rate of spawn to set, in seconds.");
AddAction(1, af_none, "Set rate of spawn", "Settings", "Set {my} rate of spawn to <i>{0}</i>", "Set the turret rate of spawn.", "SetRateOfSpawn");

AddNumberParam("Range", "The range to spawn objects");
AddAction(3, af_none, "Set range", "Settings", "Set {my} range to spawn <i>{0}</i>", "Set the emitter range.", "SetRange");
...
AddExpression(2, ef_return_number, "", "", "RateOfSpawn", "Get the current rate of spawn in seconds.");
